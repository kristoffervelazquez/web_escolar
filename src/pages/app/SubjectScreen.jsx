...
const SubjectScreen = () => {
  ...
  const getAssignments = async () => {
    ...
    const subjectAssignments = localAssignments.filter(
      (a) => a.subject_id == id
    );
    ...
    <>
      {user.type == "Teacher" ? (
        <>
          ...
          <button className="button-add" onClick={Assignment.setDummyData}>
            Llenar bdd
          </button>
          <button className="button-add" onClick={handleOpenTaskModal}>
            Nueva tarea
          </button>
